> [!NOTE]
> This is the **original upstream README** from
> [`caelestia-dots/shell`](https://github.com/caelestia-dots/shell), preserved
> verbatim for reference. It documents the shell itself — the full configuration
> reference, IPC commands and FAQ all live here and apply to this fork too.
>
> Note that the badges, funding links and support channels below belong to
> upstream, not to this fork.
>
> For what *this fork* changes, see the [main README](../README.md).
