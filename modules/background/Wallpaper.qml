...
Item {
    ...
    readonly property bool isVideo: root.source ? (source.endsWith(".mp4") || source.endsWith(".webm") || source.endsWith(".mkv")) : false
    ...
    onSourceChanged: {
        ...
        if (!root.source)
            root.imageSource = "";
        else if (!(source.endsWith(".mp4") || source.endsWith(".webm") || source.endsWith(".mkv")))
    ...
    Component.onCompleted: {
        if (root.source && !(source.endsWith(".mp4") || source.endsWith(".webm") || source.endsWith(".mkv")))
            root.imageSource = root.source;
        completed = true;
    }
